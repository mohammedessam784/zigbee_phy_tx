...
####################################################################################
set_input_delay -clock clk -max 2.00 [remove_from_collection [all_inputs] [get_ports {clk scan_clk}]]
...
#################################################################################
set_driving_cell -lib_cell IBUFFX2 [remove_from_collection [all_inputs] [get_ports {clk scan_clk}]]
